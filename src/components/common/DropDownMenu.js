...
function DropDownMenu({addFunc, editFunc, deleteFunc}) {
            ...
            <FontAwesomeIcon className="fa faEllipsisV" icon={faEllipsisV}/>
            {
                state
                    ? <ul className="dropDownMenu-items" onMouseEnter={showDropDownMenu}>
                        ...
                        <li onClick={()=> {addFunc();}}><FontAwesomeIcon className="fa faPlus" icon={faPlus}/></li>
                        <li onClick={()=> {editFunc();}}><FontAwesomeIcon className="fa faList" icon={faList}/></li>
                        <li onClick={()=> {deleteFunc();}}><FontAwesomeIcon className="fa faTrash" icon={faTrash}/></li>  
                    </ul>
                    : null
            }
